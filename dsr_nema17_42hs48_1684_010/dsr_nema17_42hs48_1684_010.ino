/*
Code Version 10:- Minimal Code with (Change dt_micro for speed) No Interrupts , no Pwm , Bare Minimum Code
...
volatile int dt_micro = 100;//Lower the value For Higher the Speed
